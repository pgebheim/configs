...
if main_syntax != 'actionscript' || exists("actionscript")
  ...
  unlet b:current_syntax
  syn region  Script start=+<[mf]x:Script[^>]*>+ keepend end=+</[mf]x:Script>+me=s-1 contains=@mxmlScript,mxmlCssStyleComment,mxmlScriptTag,@htmlPreproc
  syn region  mxmlScriptTag     contained start=+<[mf]x:Script+ end=+>+       contains=htmlTagN,htmlString,htmlArg,htmlValue,htmlTagError,htmlEvent
...
if main_syntax == "mxml"
  ...
  syn sync match mxmlHighlight groupthere Script "<[mf]x:Script"
