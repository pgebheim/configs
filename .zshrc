...
plugins=(gitfast autojump git-extras scd rails rake ruby python gulp sudo heroku zsh-syntax-highlighting zsh-autosuggestions nvm yarn)

# User configuration

export PATH="$PATH:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/snap/bin:$HOME/.local/bin:$HOME/.rbenv/bin:$HOME/go/bin"
...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(root_indicator os_icon dir dir_writable vcs newline)
